...
export default function Qualifications() {
  return (
    <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper', p: 3}}>
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Sri Aadarsh" src="https://thumbs.dreamstime.com/b/young-woman-avatar-cartoon-character-profile-picture-young-brunette-woman-short-hair-avatar-cartoon-character-vector-149728784.jpg" />
        </ListItemAvatar>
        <ListItemText
      ...
      <ListItem alignItems="flex-start">
        <ListItemAvatar>
          <Avatar alt="Sai SI" src="https://cdn4.vectorstock.com/i/1000x1000/67/98/lovely-girl-avatar-of-cute-little-brunette-girl-vector-21906798.jpg" />
        </ListItemAvatar>
        <ListItemText
          primary="Vasanth Valley High School"
          secondary={
            <React.Fragment>
              <Typography
                sx={{ display: 'inline' }}
